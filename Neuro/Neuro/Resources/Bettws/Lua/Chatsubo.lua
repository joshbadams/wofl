...
Bridge = Room:new {
	...
	longDescription = "You are under a bridge, overlooking a peaceful, yet powerful, river pouring down from the mountains. You arrived in Bettws-y-Coed this morning, and have already seen most there is to see.",
...
function Bridge:GiveMoney(amount)
