	...
	pages = {
		...
		['bbs_view'] = {
			...
			items = {
				...
				{ date = 111558, to = s.name, from = "Bosch", message = "Remember your old pal Anonymous Bosch? Remember how I borrowed your Cryptology skill chip siz month ago and forgot to give it back? Well, I dropped it off with Shive at the Gentleman Loser for you to pick up. Thanks. Sorry I took so long." },
